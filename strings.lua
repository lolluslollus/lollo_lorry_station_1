	...
	return {
		en = {
			["_DESC"] = [[
				...
				To place one, make the streets first and leave some empty space for the station, which comes with its own piece of road attached. Help yourself with the slicer, you will find it in the street construction menu.
